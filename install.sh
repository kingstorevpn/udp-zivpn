...
# --- License Info ---
LICENSE_URL="https://raw.githubusercontent.com/kingstorevpn/izin/main/ip"
...
function show_expired_message_and_exit() {
    ...
    echo -e "silakan hubungi admin https://wa.me/6281573872702 \n"
...
function show_menu() {
    ...
    echo -e "${YELLOW}╔═══════════// ${CYAN}kigstore PREMIUM${YELLOW} //═════════════╗${NC}"
    _draw_info_panel
...
echo "✅ Instalasi selesai. Service ZiVPN harusnya aktif dan panel bisa mendeteksi."
    ...
    wget -O /usr/local/bin/zivpn_helper.sh https://raw.githubusercontent.com/kingstorevpn/udp-zivpn/main/zivpn_helper.sh
    if [ $? -ne 0 ]; then
